...
const calcCurDate = (month:any, year:any) => {
...
const buildHolidayCal = (holiday:any, days:any) => {
...
export const dayInMonth = (year:any, numbMonth:any) => {
...
export const getWeeksInMonth = (year:any, month:any) => {
